...
background_image = Image.open("D:\khwaja-moinuddin-chishti-urdu-arabi-farsi-university-lucknow-219495.jpg")
...
message = tk.Label(window, text="Real Time Automatic Face Detection Attendance System ", fg="black", width=50,
